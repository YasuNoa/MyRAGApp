...
class CourseViewModel: ObservableObject {
    ...
    func fetchCourses() async {
        ...
        do {
            ...
            AppLogger.knowledge.error("❌ Failed to fetch courses: \(error.localizedDescription)")
    ...
    func createCourse(title: String, color: String, icon: String?) async -> Bool {
        ...
        do {
            ...
            AppLogger.knowledge.error("❌ Failed to create course: \(error.localizedDescription)")
