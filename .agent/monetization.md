...
| **資料保存数** | 5ファイル<br><small>(Knowledgeのみ)</small> | 100ファイル<br><small>(全教科・サークル資料)</small> | 1000ファイル<br><small>(過去問アーカイブ)</small> |
| **音声解析 (回数)** | 5回 / 日<br><small>(JST 0時リセット)</small> | 無制限 | 無制限 |
